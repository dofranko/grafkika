...
class Engine {
    ...
    constructor(gl, canvas) {
        ...
        this.program_info = {
            ...
            locations: {
                attributes: {
                    position: gl.getAttribLocation(shader_program, "a_position"),
                    normal: gl.getAttribLocation(shader_program, "a_normal"),
                },
                uniforms: {
                    color: gl.getUniformLocation(shader_program, "u_color"),

                    light_position: gl.getUniformLocation(shader_program, "u_lightPos"),
                    ambient_strength: gl.getUniformLocation(shader_program, "u_ambientStrength"),
                    light_color: gl.getUniformLocation(shader_program, "u_lightColor"),

                    projection: gl.getUniformLocation(shader_program, "u_projection"),
                    view: gl.getUniformLocation(shader_program, "u_view"),
                    model: gl.getUniformLocation(shader_program, "u_model"),

                    fog_near: gl.getUniformLocation(shader_program, "u_fogNear"),
                    fog_far: gl.getUniformLocation(shader_program, "u_fogFar"),
                    fog_color: gl.getUniformLocation(shader_program, "u_fogColor"),

                    first: gl.getUniformLocation(shader_program, "first"),
                },
            },
        };
