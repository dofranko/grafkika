...
var drawBufferFace = function (gl, rotation, move, projection, buffer, textureId, textureUnit) {
    ...
    */
    ...
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, filters[choosenFiltering % 2]);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, filters[choosenFiltering]);
...
var redraw = function () {
    ...
    console.log(filtersTranslations[choosenFiltering]);
};
...
function onKeyDown(e) {
    ...
    switch (code) {
        ...
        case 77:
            choosenFiltering = (choosenFiltering + 1) % 6;
        /*
          case 82: // R
          case 81: // Q
          case 69: // E
...
window.onload = function () {
    ...
    for (var skyboxStep = 0; skyboxStep < 6; skyboxStep++) {
        ...
        boxFaceTextures.push(myCreateTexture2d(gl, filters[0]));
    }
...
function myCreateTexture2d(gl, filtering) {
    ...
    img.addEventListener('load', () => {
        ...
        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
        console.log((img.height & (img.height - 1)));
