...
function getShadersStrings() {
    return {
        ...
        vertex_shader_string: `
            ...
            void main() {
                fragColor = vertColor;
                gl_Position = vec4((vertPosition/resolution)*2.0-1.0, 0.0, 1.0);
                gl_PointSize = 5.0;
            }
        `
    }
...
class WebGL {
    ...
    constructor(canvas) {
        ...
        //zadanie C
        gl.bindAttribLocation(program, 9, "vertColor");
     ...
     */
    draw(data_array, type = "TRIANGLES") {
        const gl = this.gl
        const attribs_per_vertex = 5;
        ...
        gl.vertexAttribPointer(
            ...
            5 * Float32Array.BYTES_PER_ELEMENT, //rozmiar każdego vertexu
            0 //offset w tablicy
        );
        gl.vertexAttribPointer(
